...
description: Design spec for the A4 resume and cover letter in src/, applied directly in those documents rather than generated by a framework. Values were measured from the rendered documents, so a different renderer can rebuild the same output without re-deriving them.
colors:
  surface: "#ffffff"
  ink: "#23343c"
  ink-strong: "#1f3139"
